  ...
  return (
    <main className='w-full flex flex-col justify-center items-center py-10'>
      ...
      <TabGroup className='mt-6 w-full'>
        <TabList className='flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:border-gray-700 dark:text-white w-full items-center justify-center'>
          <Tab className='inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-yellow-500 dark:hover:bg-yellow-500 dark:hover:text-gray-700'>
            Consumos
          </Tab>
          <Tab className='inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-yellow-500 dark:hover:bg-yellow-500 dark:hover:text-gray-700'>
            Tabla Tramo/Día
