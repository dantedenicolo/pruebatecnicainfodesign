...
import { Dashboard, Inbox, Kanban, OpenSidebar, SingIn, SingUp, User } from '../../Icons';
  ...
  return (
    <div>
      <button
        ...
        type="button"
        className="inline-flex items-center p-2 mt-2 ml-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-00 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
      >
        <span className="sr-only">Open sidebar</span>
        <OpenSidebar className="w-6 h-6" />
      </button>
